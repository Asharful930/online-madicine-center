...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 ml-auto">
            <div class="card">
                <div class="card-header"><h4>{{ isset($url) ? ucwords($url) : ""}} {{ __('Registration') }}</h4></div>
                ...
                <div class="card-body">
                    <div class="container-fluid">
                        @isset($url)
                            ...
                            <div class="form-group row">
                                <label for="tin" class="col-md-4 col-form-label text-md-right">{{ __('Trade Licence No.') }}</label>

                                <div class="col-md-6">
                                    <input id="tin" type="text" class="form-control @error('tin') is-invalid @enderror" name="tin" value="{{ old('tin') }}" required autocomplete="tin" autofocus>
                ...
                <div class="card-footer">
                    <p>Place your registration request, an admin will verify and confirm your request!</p>
                </div>
            </div>
        </div>
    </div>
