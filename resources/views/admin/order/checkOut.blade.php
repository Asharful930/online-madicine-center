        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-hover text-center" id="usertable" style="width:100%">
                        <thead>
                            <tr>
                                <td>User ID</td>
                                <td>User Name</td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$user->contact}}</td>
                                <td>{{$user->address}}</td>
                                <td><button class="btn btn-primary btn-user-add" data-id="{{$user->id}}"
                                        data-name="{{$user->f_name . ' '. $user->l_name}}"
                                        data-address="{{$user->address}}" data-contact="{{$user->contact}}"> Add
                                    </button></td>
                            </tr>
                            @endforeach
                            @endif
                    ...
                    <form action="{{route('admin.order.store')}}" method="POST">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="user_contact" id="user_contact"
                                placeholder="User Contact" disabled>
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" name="shipping_address" placeholder="Address"
                                id="address" value="{{old('shipping_address')}}">
